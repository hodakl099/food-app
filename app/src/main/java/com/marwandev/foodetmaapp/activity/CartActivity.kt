package com.marwandev.foodetmaapp.activity
...
import com.marwandev.foodetmaapp.adapter.CartAdapter
import com.marwandev.foodetmaapp.model.ModelCart
                ...
                val jsonObjectRequest = object : JsonObjectRequest(
                    ...
                    Response.Listener {
                        ...
                        if (success) {
                            ...
                            btnPlaceOrder.text = "Place Order(Total:RM. $totalAmount)"
    ...
    fun createNotification() {
        ...
        notificationBulider.setStyle(
            NotificationCompat.BigTextStyle()
                .bigText("Ordered from $restaurantName, amounting to RM.$totalAmount")
        )
