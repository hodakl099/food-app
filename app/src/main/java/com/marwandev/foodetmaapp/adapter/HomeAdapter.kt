...
import com.marwandev.foodetmaapp.activity.MenuActivity
import com.marwandev.foodetmaapp.database.RestaurantDatabase
import com.marwandev.foodetmaapp.database.RestaurantEntity
import com.marwandev.foodetmaapp.model.ModelRestaurant
...
class HomeAdapter(val context: Context, private var itemList: ArrayList<ModelRestaurant>) :
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        holder.textViewPricePerPerson.text = "RM" + restaurant.cost_for_one + "/Person "
