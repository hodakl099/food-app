...
import com.marwandev.foodetmaapp.activity.CartActivity
import com.marwandev.foodetmaapp.model.ModelMenu
...
class MenuAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolderRestaurantMenu, position: Int) {
        ...
        holder.textViewItemPrice.text = "RM" + restaurantMenuItem.cost_for_one
